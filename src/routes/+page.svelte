<script lang="ts">
	...
	import p2 from '../public/Img/2.jpg'; // Make sure this file exists
	import p3 from '../public/Img/3.jpg';
	import p4 from '../public/Img/4.jpg';
	import p5 from '../public/Img/5.jpg';
...
<main>
	...
	<img src={p2} alt={`Page ${page}`} on:load={handleImageLoad}>
	...
	{#if page_tbc5.includes(page)}
		<img src={p5} alt={`Page ${page}`} on:load={handleImageLoad}>
