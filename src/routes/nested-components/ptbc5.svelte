...
<div class="block">
	ขณะที่คุณเดินโซเซผ่านหมอก คุณสังเกตเห็นแสงเรืองรองอยู่ข้างหน้า <br>
	คุณเดินไปใกล้และพบลูกกลมเล็กๆ ที่เรืองแสง มันให้ความรู้สึกคุ้นเคยอย่างประหลาด <br>
	ใช่แล้วมันคือความทรงจำที่มีค่าที่สุดในวัยเด็กของคุณ มันคืออะไร?
</div>
